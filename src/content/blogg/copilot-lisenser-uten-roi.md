...
Det skjedde fort. Styret spurte hva dere gjør med kunstig intelligens (KI). Konkurrentene la ut
pressemeldinger. Noen i ledergruppen hadde lest at de som ikke henger med, blir akterutseilt. Så
dere gjorde det fornuftige: kjøpte lisenser til hele organisasjonen, sendte ut en e-post om at nå
var KI tilgjengelig, og krysset av for at dere var i gang.

Et halvår senere sitter du med regningen og et ubehagelig spørsmål. Hva fikk vi egentlig igjen for
...
**Arbeidsflyten er den samme.** Folk gjør jobben sin slik de alltid har gjort. Et nytt verktøy i
margen endrer ikke det. Hvis KI skal gi gevinst, må selve måten en oppgave løses på faktisk legges
om — og det skjer ikke av seg selv fordi ikonet dukket opp i verktøylinjen.

**Opplæringen var en e-post.** De fleste fikk «her er tilgangen, lykke til». Men det å bruke KI
godt er en ferdighet, ikke en knapp. Den som ikke får se konkret hvordan en oppgave de kjenner blir
gjort bedre, prøver én gang, blir skuffet, og lar være.

**Ingen måler noe.** Hvis du ikke vet hva en oppgave kostet i tid før, kan du heller ikke vite om
...
Snu hele rekkefølgen. De som får noe igjen for KI, starter ikke med verktøyet. De starter med
arbeidet.
...
løses — med opplæring som viser det på ekte eksempler fra deres egen hverdag. Det er mindre
spektakulært enn en lansering, men det er her avkastningen bor.

**Mål før og etter.** Velg én ærlig indikator per område. Hvor lang tid tok denne oppgaven før? Hvor
...
Du trenger ikke forstå hvordan modellene fungerer for å lede dette godt. Du trenger å stille de
riktige spørsmålene og kjenne igjen et godt svar. Her er noen som avslører fort om en satsing — eller
en leverandør — har tenkt helheten:

- **«Hvilket konkret problem løser dette, og hvordan jobber folk annerledes etterpå?»** Hvis svaret
  handler om verktøyets funksjoner og ikke om en endret arbeidsdag, er ikke jobben gjort.
- **«Hvordan vet vi om det virket?»** Hvis ingen kan svare med et tall de hadde fra før, måler dere
  ikke ROI — dere håper på den.
...
Det er mange som gjerne vil selge deg en stor KI-implementering nå. Noen av dem har gode produkter.
Men husk hvem som tjener på hva: en leverandør som lever av å implementere, vil sjelden konkludere
med at dere klarer dere med mindre.

Et par enkle forsvar:

- **Vær skeptisk til løsninger som starter med teknologien.** Hvis en presentasjon begynner med
  plattformen og ikke med problemet ditt, har den feil rekkefølge.
- **Krev et lite, målbart første steg.** Seriøse folk er glade for å bevise verdi på ett område før
  de ber om en stor forpliktelse. De som presser på det motsatte, ber deg ta risikoen for dem.
- **Skill mellom det imponerende og det nyttige.** En glatt demo viser hva som er mulig under ideelle
  forhold. Hverdagen din er ikke ideell. Spør alltid hvordan det ser ut med deres egne, rotete data
  og deres egne oppgaver.
...
Det er ikke for sent. Lisensene dere allerede har, er mer enn nok til å begynne på riktig måte. Det
er bare å snu rekkefølgen.
